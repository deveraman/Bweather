...
abstract class $ConditionCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "text") String name, String icon, int code});
}
...
class _$_Condition implements _Condition {
  ...
  @override
  String toString() {
    return 'Condition(name: $name, icon: $icon, code: $code)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, icon, code);
